...
optional_args.add_argument("-P","--pedigree",dest="pedigree",help="Comma delimited string with names of Dam,Sire,Offspring in VCF. Must be specified if -V is specified. Default: \"parent_1,parent_2,child\"",default="parent_1,parent_2,child",required=False)
